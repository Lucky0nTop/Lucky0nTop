...
### 🎓 Ingeniero de Sistemas Junior | 🤖 IA & Data Science Enthusiast

[![GitHub](https://img.shields.io/badge/GitHub-Follow-black?style=for-the-badge&logo=github)](https://github.com/Lucky0nTop)
...
Mi enfoque combina el **pensamiento analítico** con la **creatividad técnica**, buscando siempre soluciones ingeniosas que marquen la diferencia. Cada dataset es una oportunidad para descubrir patrones ocultos y convertirlos en **decisiones informadas** que impulsen el cambio positivo.
...
| 🤖 Inteligencia Artificial | 📊 Ciencia de Datos | 📈 Análisis de Datos |
|:---:|:---:|:---:|
...
> **Impacto en Salud** | Deep Learning aplicado al diagnóstico médico

Desarrollo de modelos de clasificación de nódulos pulmonares utilizando el dataset **LIDC-IDRI**. Implementación de arquitecturas avanzadas para apoyar el diagnóstico temprano de cáncer de pulmón.
...
📺 [Ver Demo en YouTube](https://www.youtube.com/watch?v=w0xsCpMtucI)

---

### ❤️ [Predicción de Insuficiencia Cardíaca](https://github.com/Lucky0nTop/IA-1)
> **Detección Temprana de Enfermedades** | Machine Learning para la vida

Sistema de predicción de enfermedad cardíaca usando múltiples algoritmos de ML para detectar pacientes en riesgo a partir de datos clínicos.
